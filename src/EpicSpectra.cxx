...
EpicSpectra::EpicSpectra() {
  ...
  std::cout << "//// EpicSpectra::EpicSpectra()" << std::endl;
    ...
    m_DeltaTimeHF = new TH1F("DT_HF_ifBeamOn", "DT_HF_ifBeamOn", 10000, 2.499000, 2.500000);

    m_TimeHF->GetXaxis()->SetTitle("TimeHF [s] 1s/bin");
    m_DeltaTimeHF->GetXaxis()->SetTitle("Delta TimeHF [ms] 100ps/bin");
    ...
    if(m_app->HasFlag("--input-raw")){
	    ...
	    gPad->SetLogy();
            ...
            m_raw_h1[his_name] = new TH1F(his_name.c_str(), his_name.c_str(),  20000, 2498000, 2500000);
            ...
            m_raw_h2[his_name] = new TH2F(his_name.c_str(), his_name.c_str(), 1000, 2498000, 2500000, 1000, 0, 200000);
